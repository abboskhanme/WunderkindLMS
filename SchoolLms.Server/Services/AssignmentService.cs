...
{
    private static IQueryable<Assignment> Query(AppDbContext db) =>
    ...
    public static async Task<List<AssignmentDto>> ListForTeacherAsync(AppDbContext db, string userId)
    {
    ...
    public static async Task<List<AssignmentDto>> ListAllAsync(AppDbContext db)
    {
    ...
    public static async Task<List<AssignmentDto>> ListForClassAsync(AppDbContext db, string classId)
    {
    ...
    public static async Task<Assignment?> FindAsync(AppDbContext db, string id) =>
        await Query(db).FirstOrDefaultAsync(a => a.Id == id);

    public static async Task<AssignmentDto> CreateAsync(AppDbContext db, string userId, SaveAssignmentRequest req)
    {
    ...
    public static async Task<bool> UpdateAsync(AppDbContext db, string id, SaveAssignmentRequest req)
    {
    ...
    public static async Task<bool> DeleteAsync(AppDbContext db, string id)
    {
    ...
    public static async Task<AssignmentResultDto?> GetResultsAsync(AppDbContext db, string assignmentId)
    {
    ...
    /// </summary>
    public static async Task<AssignmentScoreboardDto?> GetScoreboardAsync(AppDbContext db, string classId)
    {
    ...
    public static async Task<StudentAssignmentScoresDto> ScoresForStudentAsync(
        AppDbContext db, string classId, string studentId)
    {
        var all = await Query(db).ToListAsync();
    ...
    public static async Task<bool> SetSubmissionAsync(
        AppDbContext db, string assignmentId, string studentId, bool completed, int? score)
    {
    ...
    public static async Task<StudentAssignmentDetailDto?> GetForStudentAsync(
        AppDbContext db, string assignmentId, string classId, string studentId)
    {
    ...
    public static async Task<SubmitResultDto?> SubmitAsync(
        AppDbContext db, string assignmentId, string classId, string studentId, SubmitAssignmentRequest req)
    {
        var a = await Query(db).FirstOrDefaultAsync(x => x.Id == assignmentId);
        if (a is null || !a.ClassIds.Contains(classId)) return null;
    ...
    private static async Task<List<AssignmentDto>> ToDtosAsync(AppDbContext db, List<Assignment> list)
    {
        var subjects = await db.Subjects.ToDictionaryAsync(s => s.Id, s => s.Name);
    ...
    private static async Task<AssignmentDto> ToDtoAsync(AppDbContext db, Assignment a)
    {
        var subjects = await db.Subjects.ToDictionaryAsync(s => s.Id, s => s.Name);
        var classes = await db.Classes.ToDictionaryAsync(c => c.Id, c => c.Name);
