...
public static class JournalService
{
    ...
    public static async Task<List<JournalColumnDto>> ComputeColumnsAsync(
        AppDbContext db, string classId, string subjectId, int quarter)
    {
    ...
    /// </summary>
    public static async Task SetEntryAsync(AppDbContext db, SetJournalEntryRequest req)
    {
    ...
    public static async Task SetQuarterGradeAsync(AppDbContext db, SetQuarterGradeRequest req)
    {
    ...
    public static async Task SetNoteAsync(AppDbContext db, SetLessonNoteRequest req)
    {
        var note = await db.LessonNotes.FirstOrDefaultAsync(n =>
            n.ClassId == req.ClassId && n.SubjectId == req.SubjectId &&
            n.Quarter == req.Quarter && n.Date == req.Date && n.Period == req.Period &&
