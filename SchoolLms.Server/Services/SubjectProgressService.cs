...
/// (<see cref="Models.LessonNote.Conducted"/>) asosida hisoblanadi. LMS moduliga bog'liq EMAS.
///
...
public static class SubjectProgressService
{
    ...
    public static async Task<List<LessonSlot>> ClassSlotsAsync(
        AppDbContext db, string classId, int quarter, int? studentSubGroup = null)
    {
    ...
    public static async Task<StudentSubjectsProgressDto> ForStudentAsync(
        AppDbContext db, string classId, int quarter, int studentSubGroup)
    {
    ...
    public static async Task<SubjectProgressDetailDto?> ForStudentSubjectAsync(
        AppDbContext db, string classId, int quarter, int studentSubGroup, string subjectId)
    {
        var slots = (await ClassSlotsAsync(db, classId, quarter, studentSubGroup))
    ...
    /// </summary>
    public static async Task<TeacherProgressDto> ForTeacherAsync(AppDbContext db, string teacherId, int quarter)
    {
        var qp = await db.Quarters.FirstOrDefaultAsync(x => x.Quarter == quarter);
