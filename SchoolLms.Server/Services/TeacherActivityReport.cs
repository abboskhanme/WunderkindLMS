...
public static class TeacherActivityReport
{
    ...
    public static async Task<List<TeacherReportRowDto>> BuildOverviewAsync(AppDbContext db, int quarter)
    {
    ...
    public static async Task<TeacherReportDetailDto?> BuildDetailAsync(AppDbContext db, string teacherId, int quarter)
    {
    ...
    private static async Task<(
        ...
        Dictionary<string, string> SubjectNames)> ComputeAsync(AppDbContext db, int quarter)
    {
