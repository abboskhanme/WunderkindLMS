...
public static class TuitionService
{
    ...
    public static async Task<(int Count, decimal Total)> AccrueMonth(AppDbContext db, string month)
    {
    ...
    public static async Task<List<string>> AccrueDue(AppDbContext db)
    {
