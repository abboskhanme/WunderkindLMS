...
/**
 * O'quvchi/o'qituvchi profilida tizimga kirish ma'lumotlarini (login/parol)
 * nusxalash tugmasi bilan ko'rsatadi.
 */
export function CredentialsBox({ credentials, loading }: Props) {
  return (
