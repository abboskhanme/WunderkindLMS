...
import { CalendarDays, ChevronRight, Users2 } from 'lucide-react'
...
export function SchedulePage() {
  ...
  useEffect(() => {
    Promise.all([getClasses(), getGroupLessonsSwitch().catch(() => null)])
      .then(async ([cl, sw]) => {
        setClasses(cl)
        setFlag(sw)
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-400">
          Jadval yaratish va haftalarga biriktirish uchun sinf yoki o'quv guruhini tanlang
        </p>
      </div>
